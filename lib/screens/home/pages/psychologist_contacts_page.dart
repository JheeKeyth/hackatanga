...
List<List<String>> contacts = [
  ["Ana Carolina", "12:02", "3"],
  ["Flávio Ribeiro", "02:02", "4"],
  ["Roberto Firmino", "13:02", "1"],
  ["Ronaldo Santos", "12:52", "5"],
  ["Maria Juventina", "10:32", "2"],
];

class PsycologistContactsPage extends StatefulWidget {
  @override
  _PsycologistContactsPageState createState() =>
      _PsycologistContactsPageState();
}
          ...
          floatingActionButton: FloatingActionButton(
            ...
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => Psychologist()));
            },
